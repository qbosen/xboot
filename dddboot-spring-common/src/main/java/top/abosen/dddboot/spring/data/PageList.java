package top.abosen.dddboot.spring.data;

import com.baomidou.mybatisplus.core.metadata.IPage;
import org.springframework.data.domain.Page;
import top.abosen.dddboot.shared.data.SliceList;
import top.abosen.dddboot.shared.utility.CastUtils;
...
public class PageList<T> implements SliceList<T> {
    ...
    @Override public <R> SliceList<R> of(List<R> elements, long totalSize) {
