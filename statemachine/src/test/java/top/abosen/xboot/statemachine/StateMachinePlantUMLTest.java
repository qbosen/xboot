...
import top.abosen.xboot.statemachine.impl.Debugger;
import top.abosen.xboot.statemachine.impl.MermaidUMLVisitor;

import java.util.stream.Stream;

import static top.abosen.xboot.statemachine.StateMachinePlantUMLTest.PriceAdjustmentTaskEventEnum.*;
import static top.abosen.xboot.statemachine.StateMachinePlantUMLTest.PriceAdjustmentTaskStatusEnum.*;
...
public class StateMachinePlantUMLTest {
    ...
    public void testUML() {
        ...
        val stateMachine = builder.build("AdjustPriceTask");
        String uml = stateMachine.accept(new MermaidUMLVisitor());
